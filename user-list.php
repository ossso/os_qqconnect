...
$third_users = os_qqconnect_Event_GetUserList();
?>
<style>
    .user-list-container {
        -webkit-display: flex;
        ...
        <div class="user-list-container">
            ...
            <div class="user-list-item" data-id="<?php echo $item->ID ?>">
                <div class="item-header">
                    ...
                    <div class="update-time">最后登录<?php echo os_qqconnect_AgoTime($item->UpdateTime) ?></div>
                </div>
...
!function() {
    var option = function(type, id, cb) {
        $.ajax({
            type: "post",
            url: "<?php echo os_qqconnect_Event_GetURL('manage') ?>",
            data: {
                type: type,
                id: id
            },
